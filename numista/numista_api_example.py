...
response = requests.get(
    endpoint + "/issuers", params={"lang": "en"}, headers={"Numista-API-Key": api_key}
)
...
# redirect_uri = (
#     "https://postman-echo.com/get"  # Should normally be a URL to your application
# )
redirect_uri = "http://0.0.0.0:8080/get"
state = str(uuid4())
url_template = (
    "https://{language}.numista.com/api/oauth_authorize.php"
    "?response_type=code"
    "&client_id={client_id}"
...
print(
    "Please open the following URL, authenticate yourself "
...
if state == returned_state:
    ...
    print("Incorrect state. You should stop the process here.")
